...
FN_MC = '/home/psimmerl/mds_analysis/data/raw/mc_pedro.root'
FN_R3 = '/home/psimmerl/mds_analysis/data/raw/data_pedro.root'
...
for rdfn in ('mc', 'r3'):
    ...
    fn_out = f'data/processed/{rdfn}_{STAT}_hlt566.root'
    ...
    fn_out = f'data/processed/{rdfn}_{STAT}_hlt569.root'
